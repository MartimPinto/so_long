...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   enemy_animations_bonus.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mcarneir <mcarneir@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/25 13:14:09 by mcarneir          #+#    #+#             */
/*   Updated: 2023/07/25 13:14:12 by mcarneir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	enemy_atk_left(t_game *game, int enemies)
{
	...
	put_square(game, "./textures/E_Atk1_L.xpm", 
		game->enemy_x[enemies] * SIZE + ((SIZE / 3) * 2), 
		game->enemy_y[enemies] * SIZE);
	put_square(game, "./textures/Grass.xpm", 
		grass * SIZE, game->enemy_y[enemies] * SIZE);
	usleep(30000);
	put_square(game, "./textures/E_Atk2_L.xpm", 
		game->enemy_x[enemies] * SIZE + (SIZE / 3), 
		game->enemy_y[enemies] * SIZE);
	put_square(game, "./textures/Grass.xpm", 
		grass * SIZE, game->enemy_y[enemies] * SIZE);
	usleep(30000);
