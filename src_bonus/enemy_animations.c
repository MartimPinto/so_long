...
/*   Updated: 2023/07/13 16:57:31 by mcarneir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	enemy_atk_up(t_game *game, int enemies)
{
	...
	put_square(game, "./textures/E_Idle_L.xpm", 
		game->enemy_x[enemies] * SIZE, game->enemy_y[enemies] * SIZE + ((SIZE / 4) * 3));
	put_square(game, "./textures/Grass.xpm", 
		game->enemy_x[enemies] * SIZE, grass * SIZE);
	usleep(70000);
	put_square(game, "./textures/E_Atk1_L.xpm", 
		game->enemy_x[enemies] * SIZE, game->enemy_y[enemies] * SIZE + ((SIZE / 4) * 2));
	put_square(game, "./textures/Grass.xpm", 
		game->enemy_x[enemies] * SIZE, grass * SIZE);
	usleep(60000);
	put_square(game, "./textures/E_Atk2_L.xpm", 
		game->enemy_x[enemies] * SIZE, game->enemy_y[enemies] * SIZE + (SIZE / 4));
	put_square(game, "./textures/Grass.xpm", 
		game->enemy_x[enemies] * SIZE, grass * SIZE);
	usleep(60000);
...
void	enemy_atk_left(t_game *game, int enemies)
{
	...
	put_square(game, "./textures/E_Idle_L.xpm", 
		game->enemy_x[enemies] * SIZE + ((SIZE / 4) * 3), game->enemy_y[enemies] * SIZE);
	put_square(game, "./textures/Grass.xpm", 
		grass * SIZE, game->enemy_y[enemies] * SIZE);
	usleep(70000);
	put_square(game, "./textures/E_Atk1_L.xpm", 
		game->enemy_x[enemies] * SIZE + ((SIZE / 4) * 2), game->enemy_y[enemies] * SIZE);
	put_square(game, "./textures/Grass.xpm", 
		grass * SIZE, game->enemy_y[enemies] * SIZE);
	usleep(60000);
	put_square(game, "./textures/E_Atk2_L.xpm", 
		game->enemy_x[enemies] * SIZE + (SIZE / 4), game->enemy_y[enemies]* SIZE);
	put_square(game, "./textures/Grass.xpm", 
		grass * SIZE, game->enemy_y[enemies] * SIZE);
	usleep(60000);
	put_square(game, "./textures/E_Idle_L.xpm", 
